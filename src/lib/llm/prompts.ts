...
КРИТИЧЕСКИ ВАЖНО: Верни ТОЛЬКО валидный JSON. НЕ добавляй markdown заголовки (#), НЕ добавляй пояснительный текст до или после JSON. Начни ответ сразу с символа { и закончи символом }.
...
ПОМНИ: Твой ответ должен начинаться с { и заканчиваться }. Никаких заголовков, никакого текста до или после JSON.`;
}
